...
var url_parser = __webpack_require__(181);
// EXTERNAL MODULE: ./src/scripts/views/pages/resto-list.js
var resto_list = __webpack_require__(53);
// EXTERNAL MODULE: ./src/scripts/views/pages/resto-detail.js
var resto_detail = __webpack_require__(796);
// EXTERNAL MODULE: ./src/scripts/views/pages/resto-liked.js
var resto_liked = __webpack_require__(104);
...
// Content
var routes = {
  '/': resto_list/* default */.A,
  '/resto-list': resto_list/* default */.A,
  '/detail/:id': resto_detail/* default */.A,
  '/liked': resto_liked/* default */.A
};
  ...
  return _createClass(App, [{
    ...
    value: function () {
      var _renderPage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var url, page, main, skipLinkElem;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
            ...
            case 9:
              ...
              skipLinkElem = document.querySelector('.skip_link');
    ...
    key: "renderNotFoundPage",
    value: function renderNotFoundPage(main) {
